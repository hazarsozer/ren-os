...
#     Full wiki restore. Overwrites $SF_WIKI_ROOT.
#
...
PLUGIN_DATA="${CLAUDE_PLUGIN_DATA:-$HOME/.claude/plugins/data/startup-framework-sf-marketplace}"
...
Current target:    \$SF_WIKI_ROOT or \$CLAUDE_PLUGIN_OPTION_WIKIROOT or ~/.startup-framework/wiki
EOF
    ;;
