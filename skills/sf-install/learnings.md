...
_No learnings yet — skill is freshly authored. As friends run `/sf:install` and surface surprises, capture them here. Common categories worth watching:_
...
- _Stage 3 feed-detection misclassifications (a repo that was wrongly tagged 'first-friend-bootstrap' when it was actually 'already-cloned')_
...
- _Resume-protocol corner cases (concurrent /sf:install runs racing on the checkpoint file)_
