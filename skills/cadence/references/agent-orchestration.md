...
2. **Skill** — a *repeatable procedure* you'll want again. Author or invoke a skill — `standard` (full contract), or `tier: lightweight` for a one-prompt shortcut (see the ADR-011 amendment, 2026-06-27). One job, composable.
...
- ADR-011 amendment (2026-06-27) — the `tier: lightweight` skill carve-out referenced at rung 2.
